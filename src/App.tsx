  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/parents/safety" element={<StaticPage />} />
        <Route path="/parents/privacy" element={<StaticPage />} />
        <Route path="/parents/social-cert" element={<StaticPage />} />
        <Route path="/parents/paid-services" element={<StaticPage />} />
        <Route path="/parents/smart-holidays" element={<StaticPage />} />
        <Route path="/parents/anti-corruption" element={<StaticPage />} />
        <Route path="/parents/quality-assessment" element={<StaticPage />} />
        <Route path="/parents/anti-extremism" element={<StaticPage />} />
        <Route path="/parents/temperature" element={<StaticPage />} />

        {/* Сведения об образовательной организации */}
        <Route path="/about-info" element={<AboutInfoPage />} />
        <Route path="/about-info/structure" element={<StaticPage />} />
        <Route path="/about-info/documents" element={<StaticPage />} />
        <Route path="/about-info/education" element={<StaticPage />} />
        <Route path="/about-info/leadership" element={<LeadershipPage />} />
        <Route path="/about-info/teachers-staff" element={<TeachersStaffPage />} />
        <Route path="/about-info/facilities" element={<StaticPage />} />
        <Route path="/about-info/paid-education" element={<StaticPage />} />
        <Route path="/about-info/finances" element={<StaticPage />} />
        <Route path="/about-info/vacancies" element={<StaticPage />} />
        <Route path="/about-info/scholarships" element={<StaticPage />} />
        <Route path="/about-info/international" element={<StaticPage />} />
        <Route path="/about-info/nutrition" element={<StaticPage />} />
      </Routes>
    </BrowserRouter>
  );
}
